...
git clone --depth=1 https://github.com/asvow/luci-app-tailscale package/luci-app-tailscale-integration
git clone --depth=1 https://github.com/QiuSimons/luci-app-daed package/luci-app-dae
